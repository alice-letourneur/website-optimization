...
//Create variable to store elements with class .randomPizzaContainer is now outside of the function changePizzaSizes
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0; i < 35; i++) {
    ...
    elem.src = "images/sliding_pizza.png";
